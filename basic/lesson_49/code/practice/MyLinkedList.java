...
public interface MyLinkedList {
    ...
    MyLinkedListImpl.Node get(int index) throws IndexOutOfBoundsException;
    ...
    MyLinkedListImpl reverseLinkedList();

    MyLinkedListImpl reverseLinkedList(int startIndex);

    MyLinkedListImpl reverseLinkedList(int startIndex, int endIndex);
}
