...
//
//        return getFloor() == house.getFloor() && this.getSquare() == house.getSquare() &&
//                this.getAddress().equals(house.getAddress()); // сравнение идет только по этажу, если этаж один и тот же, то считаем,
//        // что объекты равны
//    }

    public static void main(String[] args) {
        House h1 = new House(10,"abc45",30);
        House h2 = new House(12,"abc",30);
